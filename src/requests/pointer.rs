...
#[derive(Clone, Copy, Debug)]
pub struct TranslatedCoordinates {
    pub same_screen: bool,
    pub child: Option<Window>,
    pub dst_x: i16,
    pub dst_y: i16,
...
impl X11Connection {
    pub async fn query_pointer(&self, window: Window) -> Result<QueryPointerResponse> {
    ...
    pub async fn get_motion_events(&self, window: Window, start: Timestamp, stop: Timestamp) -> Result<Vec<MotionEvent>> {
    ...
    pub async fn translate_coordinates(&self, src_window: Window, dst_window: Window, src_x: i16, src_y: i16) -> Result<TranslatedCoordinates> {
    ...
    pub async fn warp_pointer(&self, src_window: Window, dst_window: Window, src_x: i16, src_y: i16, src_width: u16, src_height: u16, dst_x: i16, dst_y: i16) -> Result<()> {
    ...
    pub async fn set_input_focus(&self, revert_to: InputFocusRevert, window: InputFocusWindow, time: Timestamp) -> Result<()> {
    ...
    pub async fn get_input_focus(&self) -> Result<(InputFocusRevert, InputFocusWindow)> {
        ...
        Ok((
            ...
            match reply.focus_window {
                ...
                handle => InputFocusWindow::Window(Window { handle }),
            }
        ))
    }
}