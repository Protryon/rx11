use crate::coding::xinput2::{
    self, ChangePropertyMode, PropertyFormat, XIChangePropertyRequest, XIDeletePropertyRequest, XIGetPropertyRequest, XIGetPropertyResponse,
    XIListPropertiesRequest, XIListPropertiesResponse,
};
...
impl<'a> Device<'a> {
    pub async fn list_properties(self) -> Result<Vec<Atom>> {
        let reply = send_request_xinput!(
            self.connection,
            XIOpcode::XIListProperties,
            XIListPropertiesResponse,
    ...
    async fn change_property(self, mode: ChangePropertyMode, property: Atom, type_: Atom, value: impl Into<PropertyValue>) -> Result<()> {
        ...
        send_request_xinput!(
            ...
            XIChangePropertyRequest {
                ...
                value: match value {
                    PropertyValue::U8(items_8) => xinput2::PropertyValue::Items8 {
                        items_8,
                        num_items: 0
                    },
                    PropertyValue::U16(items_16) => xinput2::PropertyValue::Items16 {
                        items_16,
                        num_items: 0
                    },
                    PropertyValue::U32(items_32) => xinput2::PropertyValue::Items32 {
                        items_32,
                        num_items: 0
                    },
                },
    ...
    pub async fn get_property_full(self, property: Atom, type_: Option<Atom>, offset: u32, length: u32, delete: bool) -> Result<PropertyResponse> {
        let reply = send_request_xinput!(
            self.connection,
            XIOpcode::XIGetProperty,
            XIGetPropertyResponse,
        ...
        Ok(PropertyResponse {
            ...
            value: match reply {
                XIGetPropertyResponse {
                    items_8: Some(items_8),
                    ..
                } => PropertyValue::U8(items_8),
                XIGetPropertyResponse {
                    items_16: Some(items_16),
                    ..
                } => PropertyValue::U16(items_16),
                XIGetPropertyResponse {
                    items_32: Some(items_32),
                    ..
